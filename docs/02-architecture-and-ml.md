...
Это **план реализации**, а не описание уже работающего продукта. Сейчас в репозитории нет приложения. Примеры данных ниже учебные; они объясняют контракт, но не заменяют реальные логи на проверке и защите. Ссылки на пути будущего кода обозначают файлы, которые предстоит создать.
...
Пока созданы только документы и README. Остальное дерево — договорённость о будущей реализации.
