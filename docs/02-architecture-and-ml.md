...
Это дерево целевого приложения. Фактическая структура объединённого backend и ML описана в корневом README; дерево выше остаётся первоначальным планом.
