...
Документы описывают наше предлагаемое решение. Полный сервис пока не реализован; отдельную ML-часть уже можно запускать по [инструкции](../ml/README.md). Основа — PDF «Кейс 2. Что наделал агент», страницы 2–11. Примеры ниже учебные: на защите мы должны показывать настоящую сессию.
